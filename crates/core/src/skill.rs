...
pub trait FromParams: Sized {
    ...
    fn new(name: &str, owner: Character, skill_mask_offset: usize, params: Self::Params) -> Self;
}
...
macro_rules! define_skill {
    ($($skill_name:tt),* $(,)?) => {
        ...
        impl SkillMeta for Skill {
            ...
            dispatch_method!(Skill, fn owner(&self) -> Character, $($skill_name),*);
        ...
        impl SkillOps for Skill {
            ...
            dispatch_method!(Skill, fn apply<'b, 'c: 'b>(&self, caster: &'c mut StateData, targets: &'b mut [&'c mut StateData]),  $($skill_name),*);
        }
